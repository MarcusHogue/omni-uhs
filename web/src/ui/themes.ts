...
export const THEMES: Theme[] = [
  ...
  },
  {
    id: 'win95',
    name: 'Windows 95',
    note: 'Teal desktop, gradient title bar, and a taskbar along the bottom.',
    group: 'Retro',
  ...
  },
  {
    id: 'win31',
    name: 'Windows 3.1',
    note: 'Grey Program Manager desktop, flat navy title bar, menu-bar tabs.',
    group: 'Retro',
    swatch: ['#7f7f7f', '#c0c0c0', '#000080'],
  },
  {
    id: 'system7',
    name: 'System 7',
    note: 'Striped title bar, hard drop shadow, dithered Finder desktop.',
    group: 'Retro',
  ...
  },
  {
    id: 'platinum',
    name: 'Mac OS 9',
    note: 'Pinstriped platinum greys with a soft blue highlight.',
    group: 'Retro',
  ...
  },
  {
    id: 'workbench',
    name: 'Workbench 1.3',
    note: 'Amiga blue screen, white windows, hatched drag bar, orange accents.',
    group: 'Retro',
  ...
  },
  {
    id: 'dos',
    name: 'DOS',
    note: 'Text mode: a blue screen in a double-line box, everything monospaced.',
    group: 'Retro',
    swatch: ['#0000aa', '#00aaaa', '#ffff55'],
  },
];
